...
doc = Nokogiri::HTML(open("https://www.sec.gov/cgi-bin/browse-edgar?action=getcurrent&datea=&dateb=&company=&type=8-k&SIC=&State=&Country=&CIK=&owner=include&accno=&start=0&count=100000000"))
href = []
links = doc.css('a')
links.each do |link|
  if link['href'] =~ /[.][t][x][t]/
